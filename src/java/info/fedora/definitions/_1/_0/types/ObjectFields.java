 ...
 *         &lt;element name="cModel" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 ...
 *         &lt;element name="bDef" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="bMech" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
public class ObjectFields {
    ...
    @XmlElementRef(name = "fType", type = JAXBElement.class)
    protected JAXBElement<String> fType;
    @XmlElementRef(name = "cModel", type = JAXBElement.class)
    protected JAXBElement<String> cModel;
    ...
    protected List<String> bDef;
    @XmlElement(nillable = true)
    protected List<String> bMech;
    @XmlElement(nillable = true)
     ...
     *     
     */
    public JAXBElement<String> getFType() {
        return fType;
    }
     ...
     *     
     */
    public void setFType(JAXBElement<String> value) {
        this.fType = ((JAXBElement<String> ) value);
    }

    /**
     * Gets the value of the cModel property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getCModel() {
        return cModel;
    }

    /**
     * Sets the value of the cModel property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setCModel(JAXBElement<String> value) {
        this.cModel = ((JAXBElement<String> ) value);
    }
    ...
    /**
     * Gets the value of the bDef property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bDef property.
     * 
     * <p>
     ...
     * 
     */
    public List<String> getBDef() {
        if (bDef == null) {
            bDef = new ArrayList<String>();
        }
        return this.bDef;
    }

    /**
     * Gets the value of the bMech property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bMech property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBMech().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getBMech() {
        if (bMech == null) {
            bMech = new ArrayList<String>();
        }
        return this.bMech;
    }
